...
local Tab3 = homeTab:AddSection("Teleport")
...
local Undercity = Tab3:AddButton("Teleport Undercity", 
    function()
        local A_1 = 4601778915
        local Event = game:GetService("ReplicatedStorage").Remotes.WorldTeleportRemote
        Event:InvokeServer(A_1)
    end
)
local Grassland = Tab3:AddButton("Teleport Grassland", 
    function()
        local A_1 = 3475419198
        local Event = game:GetService("ReplicatedStorage").Remotes.WorldTeleportRemote
        Event:InvokeServer(A_1)
    end
)
